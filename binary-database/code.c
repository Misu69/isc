...

{
  ...
  *data_type = db_entries[i].type;
  memcpy(out_data,&db_entries[i].data,0x30);
  return 1;
}
  ...
  do {
    if (0x2d < i) {
      if (found_empty < 0) {
        ...
        memcpy(&db_entries[found_empty].data,data,0x30);
        iVar1 = 1;
      }
      return iVar1;
    }
    if (db_entries[i].key[0] == '\0') {
      ...
      if (iVar1 == 0) {
        ...
        memcpy(&db_entries[i].data,data,0x30);
        return 0;
      }
    }
    i = i + 1;
...

{
  ...
  if (local_14 < 1) {
    ...
    local_4c.sa_data._0_2_ = htons((uint16_t)local_14);
    local_4c.sa_data._2_4_ = inet_addr("127.0.0.1");
    iVar1 = bind(local_1c,&local_4c,0x10);
    if (iVar1 < 0) {
      piVar2 = __errno_location();
    ...
    local_3c[0] = 0x10;
    local_20 = accept(local_1c,&local_5c,local_3c);
    if (local_20 < 0) {
      piVar2 = __errno_location();
  ...
  local_3c[6] = process_loop();
  if (-1 < local_1c) {
    close(local_20);
    close(local_1c);
  }
  bVar3 = (int)local_3c[6] < 0;
  if (bVar3) {
